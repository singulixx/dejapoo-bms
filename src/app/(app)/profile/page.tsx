...
export default function Page() {
  ...
  const isDefaultProfilePhoto =
    !data?.profilePhoto || data.profilePhoto === "/images/user/user-03.png";
    ...
    <div className="mx-auto w-full max-w-[970px]">
      ...
      <div className="overflow-hidden rounded-[10px] bg-card shadow-1 dark:bg-gray-dark dark:shadow-card">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-card/20 p-1 backdrop-blur sm:h-44 sm:max-w-[176px] sm:p-3">
