...
export async function ChatsCard() {
  ...
  return (
    <div className="col-span-12 rounded-[10px] bg-card py-6 shadow-1 dark:bg-gray-dark dark:shadow-card xl:col-span-4">
            ...
            >
              ...
              <div className="relative flex-grow">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <span
                    className={cn(
                      "truncate text-sm font-medium-5 xl:max-w-[8rem]",
                      chat.unreadCount && "text-dark-4-6",
                    )}
                  >
