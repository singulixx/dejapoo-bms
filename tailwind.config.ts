  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        // ✅ TAMBAHAN: rotate 280 deg smooth (0 → 280 → 0)
        rotate280Smooth: {
        ...
        sway280: {
          "0%": { transform: "rotate(280deg)" }, // kanan
          "50%": { transform: "rotate(-280deg)" }, // kiri
          "100%": { transform: "rotate(280deg)" }, // balik kanan
        },
      },
      ...
      animation: {
        ...
        // ✅ TAMBAHAN: class tailwind -> animate-rotate-280-smooth
        "rotate-280-smooth": "rotate280Smooth 60s ease-in-out infinite",
      },
    },
  },
  plugins: [],
